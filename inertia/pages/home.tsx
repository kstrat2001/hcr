    ...
    <MainLayout>
      ...
      <section className="hero container flex items-center justify-between" style={{ minHeight: '80vh' }}>
        <div style={{ maxWidth: '800px' }}>
          ...
          <a href="#contact" className="btn-primary mono" style={{ 
      ...
      <section id="trap" style={{ padding: '6rem 0', background: 'var(--color-bg-light)' }}>
        <div className="container">
          <h2 className="text-center mono" style={{ fontSize: '2.5rem', marginBottom: '3rem' }}>The_AI_Trap</h2>
          <div className="grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem' }}>
            ...
            <div className="code-block" style={{ 
              ...
              <span style={{ color: '#ff4141' }}>// AI Generated "Auth"</span><br/>
              if (user.password == input.password) &#123;<br/>
              &nbsp;&nbsp;login(user);<br/>
              &#125;<br/>
              <br/>
              <span style={{ color: 'var(--color-primary)' }}>// REALITY CHECK:</span><br/>
              <span style={{ color: 'var(--color-primary)' }}>// Timing attack vulnerable. Plaintext comparison. NO.</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="solution" style={{ padding: '6rem 0' }}>
        <div className="container">
          <h2 className="text-center mono" style={{ fontSize: '2.5rem', marginBottom: '3rem' }}>The_Solution</h2>
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--color-text-muted)', marginBottom: '3rem' }}>
              I review your AI-generated codebase before you launch. I spot the hallucinations, the security holes, and the architectural dead-ends.
            </p>
            <div className="features grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
              <div style={{ padding: '2rem', border: '1px solid var(--glass-border)', background: 'var(--glass-bg)' }}>
                <h3 className="mono text-primary" style={{ marginBottom: '1rem' }}>&gt; Security</h3>
                <p>Prevent SQL injection, XSS, and logic flaws.</p>
              </div>
              <div style={{ padding: '2rem', border: '1px solid var(--glass-border)', background: 'var(--glass-bg)' }}>
                <h3 className="mono text-primary" style={{ marginBottom: '1rem' }}>&gt; Architecture</h3>
                <p>Ensure your database schema isn't a ticking time bomb.</p>
              </div>
              <div style={{ padding: '2rem', border: '1px solid var(--glass-border)', background: 'var(--glass-bg)' }}>
                <h3 className="mono text-primary" style={{ marginBottom: '1rem' }}>&gt; Optimization</h3>
      ...
      <section id="bio" style={{ padding: '6rem 0', background: 'var(--color-bg-light)' }}>
        <div className="container items-center" style={{ display: 'flex', gap: '4rem' }}>
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: '1.1rem', marginBottom: '1.5rem', lineHeight: '1.8' }}>
              Fast forward 20 years. I've managed engineering teams at <strong className="text-white">Apple</strong>, delivering software to millions. I've directed VR technology at <strong className="text-white">Digital Domain</strong>. I've built custom graphics engines and embedded systems where performance wasn't a luxury—it was physics.
            </p>

            <p style={{ fontSize: '1.1rem', marginBottom: '1.5rem', lineHeight: '1.8' }}>
              I've seen every pitfall. I know why that AI-generated "optimization" will crash your server at 3 AM. I know why that "clever" architecture will become technical debt next month.
            </p>
            
            <p style={{ fontSize: '1.1rem', color: 'var(--color-text-muted)', borderLeft: '4px solid var(--color-primary)', paddingLeft: '1rem' }}>
          ...
          <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
             <div style={{ 
               ...
               boxShadow: '0 0 20px rgba(0,0,0,0.5)'
                ...
                <div style={{ background: '#111', padding: '0.5rem 1rem', borderBottom: '1px solid #333', color: '#666', fontSize: '0.75rem' }}>
                  kain_experience.log
                </div>
                <div style={{ padding: '1.5rem', color: '#a0a0a0' }}>
                  ...
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: '#888' }}>[2019-2022]</span> <strong className="text-white">Apple</strong><br/>
                    &gt; Engineering Manager, Video Apps
                  </div>
                  
                  <div style={{ marginBottom: '0.5rem' }}>
                    <span style={{ color: '#888' }}>[2015-2018]</span> <strong className="text-white">Digital Domain</strong><br/>
                  ...
                  <div>
                    <span className="text-primary">$ check_skills</span><br/>
                    &gt; C++, OpenGL, iOS, Embedded Systems<br/>
                    &gt; Engineering Leadership, Architecture<br/>
      ...
      <section id="contact" style={{ padding: '8rem 0', textAlign: 'center' }}>
        <div className="container">
          <h2 className="mono text-primary" style={{ fontSize: '3rem', marginBottom: '2rem' }}>Ready_to_Launch?</h2>
