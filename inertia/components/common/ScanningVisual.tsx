...
export default function ScanningVisual() {
  ...
  return (
    <div className="eye-visual-container" style={{ position: 'relative', overflow: 'hidden', background: '#000' }}>
      
      {/* 1. The Glitch Layer (Background) */}
      <div className="layer-base mono" style={{ 
          padding: '1.5rem', 
      ...
      <div className="scan-mask" style={{
        ...
        <div className="layer-clean mono" style={{
            position: 'absolute',
            top: 0, 
            left: 0,
            padding: '1.5rem',
